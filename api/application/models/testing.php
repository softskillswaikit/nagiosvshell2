...
class Testing extends CI_Model
{
	...
	private function _get_return_host($assume_state_downtime, $input_array, $input_host, $input_period, $input_date, $backtrack_archive, $assume_initial_state, $first_assume_service_state)
	{
